...
import {SalaryOptions, JobTypeOptions} from '../components/FormOptions'
...
const AddJobPage = ({addJobSubmit}) => {
    ...
    const [type, setType] = useState(JobTypeOptions()[0].props.value);
    const [location, setLocation] = useState('');
    const [description, setDescription] = useState('');
    const [salary, setSalary] = useState(SalaryOptions()[0].props.value);
